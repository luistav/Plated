...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <aside className="w-64 bg-stone-900 text-stone-400 flex flex-col border-r border-stone-800 sticky top-0 h-screen">
      <div className="p-8">
      ...
      <div className="mt-auto p-8 border-t border-stone-800">
        <div className="flex items-center gap-3">
          ...
          <div className="text-xs">
            <p className="text-white font-medium">Chef Marc-Antoine</p>
            <p className="text-stone-500">Executive Chef</p>
          </div>
        </div>
      </div>
    </aside>
